...
- Evaluate whether a role/persona is defined
- Look for expected output format or constraints
- Score each category from 0 to 10
- Calculate a final average score
...
Type or paste the prompt you want to evaluate.
Example:
Write a 2‑paragraph summary of the benefits of cloud computing.
3. View Your Results
...
- Context
Does it explain background, audience, or purpose?
- Output Format & Constraints
Does it specify tone, length, or structure?
- Persona Defined
...
- Non‑technical users who want clearer prompts
